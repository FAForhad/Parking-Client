...
const Footer = () => {
    return (
        <div>
            <footer aria-label="Site Footer" style={{ backgroundColor: 'rgb(60, 10, 2)' }}>
                <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                    <div className="lg:flex lg:gap-8">
                        <div>
                            <Link to='/' className="flex items-center justify-center">
                                <GiCarDoor className="inline-block h-24 w-12 rounded-lg"></GiCarDoor>
                                <p className='text-gray-400 font-bold text-4xl'>OWN</p>
                                <GiCarKey className="inline-block h-32 w-12 rounded-lg"></GiCarKey>
                            </Link>
                        </div>
                    ...
                    <div className="mt-12 border-t border-white/10 pt-8">
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            ...
                            <nav
                                className="flex justify-center gap-4 text-xs text-gray-400 lg:justify-end"
                            >
