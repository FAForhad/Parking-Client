...
const Header = () => {
    return (
        <div>
            <section >
                <div className='rounded p-1' style={{ backgroundColor: 'hsl(9, 95%, 17%)', zIndex: '10' }} offset="1">
                </div>
                <svg
                ...
                >
                    <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
                        <linearGradient
                            ...
                            y2="0"
                        >
                            <stop stopColor="hsl(9, 95%, 17%)" offset="0"></stop>
                            <stop stopColor="hsl(9, 95%, 17%)" offset="1"></stop>
                        </linearGradient>
